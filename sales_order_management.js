...
app.post('/get-midtrans-payment',  async (req, res) => {
    var Order_Number = req.query.Order_Number;
    var total_amount = req.query.total_amount;
    ...
    var options = {
        ...
        'headers': {
            'Authorization': 'Basic TWlkLXNlcnZlci1oLTlIdWl1N3F6Uno5SDRQdEtYbjJiYmc6',
