...
setInterval(() => {
    var options = {
        'method': 'GET',
        'url': 'localhost:5002/get-all-sales-order-details',
        'headers': {
        }
    };
    ...
    var options = {
        'method': 'GET',
        'url': 'localhost:5002/get-all-customer-details',
        'headers': {
        }
    };
    request(options, function (error, response) {
    ...
    var options = {
        'method': 'GET',
        'url': 'localhost:5002/get-all-purchase-order-details',
        'headers': {
        }
    };
    request(options, function (error, response) {
    ...
    var options = {
        'method': 'GET',
        'url': 'localhost:5002/get-all-delivery-order-details',
        'headers': {
        }
    };
    request(options, function (error, response) {
    ...
    var options = {
        'method': 'GET',
        'url': 'localhost:5002/get-all-employee-details',
        'headers': {
        }
    };
    request(options, function (error, response) {
...
const update_purchase_order_in_json_to_mysql = async (sorted_collected_purchase_order_with_details) => {
    ...
    return new Promise(async resolve => {
        ...
        for(x ; x < sorted_collected_purchase_order_with_details.order_details.length; x++){
            await update_order_details(sorted_collected_purchase_order_with_details, x);
        }
        resolve(true);
    });
}

async function update_order_details(sorted_collected_purchase_order_with_details, x){
...
const insert_purchase_order_in_json_to_mysql = async (sorted_collected_purchase_order_with_details) => {
    ...
    return new Promise(async resolve => {
        ...
        var x = 0;
        for(x ; x < sorted_collected_purchase_order_with_details.order_details.length; x++){
            insertOrderDetails(sorted_collected_purchase_order_with_details, x);
        }
        resolve(true);
    });
}

async function insertOrderDetails(sorted_collected_purchase_order_with_details, x){
    setTimeout(() => {
        var thedate = new Date();
        var uniqueCode = 
            (
...
const update_delivery_order_in_json_to_mysql = async (sorted_collected_delivery_order_with_details) => {
    return new Promise(async resolve => {
        ...
        for(x ; x < sorted_collected_delivery_order_with_details.order_details.length; x++){
            await update_order_details(sorted_collected_delivery_order_with_details, x);
        }
        resolve(true);
    });
}

async function update_order_details(sorted_collected_delivery_order_with_details, x){
...
const insert_delivery_order_in_json_to_mysql = async (sorted_collected_delivery_order_with_details) => {
    return new Promise(async resolve => {
        ...
        var x = 0;
        for(x ; x < sorted_collected_delivery_order_with_details.order_details.length; x++){
            insertOrderDetails(sorted_collected_delivery_order_with_details, x);
        }
        resolve(true);
    });
}

async function insertOrderDetails(sorted_collected_delivery_order_with_details, x){
    setTimeout(() => {
        var thedate = new Date();
        var uniqueCode = 
            (
